...
public class Post extends AbstractAuditingEntity<Long> {
    ...
    // cascade = ALL: Lưu/Sửa/Xóa Post thì Hibernate tự động làm điều tương tự với PostMedia
    // orphanRemoval = true: Nếu xóa 1 ảnh khỏi danh sách này, nó sẽ tự động bị xóa trong Database
